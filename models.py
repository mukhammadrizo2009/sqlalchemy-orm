...
class User(Base):
    ...
    created_at = Column('created_at', DateTime, default=datetime.now)  # 2025-08-25 9:15
    updated_at = Column('updated_at', DateTime, onupdate=datetime.now) # 2025-08-26 13:45
